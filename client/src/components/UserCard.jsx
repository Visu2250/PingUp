    ...
    >
      ...
      <div className="flex mt-4 gap-2">
        ...
        <button
          ...
          className={`w-full py-2 rounded-md flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white transition active:scale-95 ${
            isFollowing
