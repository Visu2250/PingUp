...
//   const messgesEndRef=useRef(null)
...
//   }
//   useEffect(()=>{
//     messgesEndRef.current?.scrollIntoView({behavior:"smooth"})
//   },[messages])
//   return (
...
//   >
//     <div 
//       className={`p-2 text-sm max-w-sm bg-white text-slate-700 rounded-lg shadow ${message.to_user_id !== user_id ? 'rounded-bl-none' : 'rounded-br-none'}`}
//     >
//       {
...
//       {/* Input Box - directly at bottom, no frame */}
...
import { addMessage,fetchMessages, resetMessages } from '../feature/messages/messagesSlice';
