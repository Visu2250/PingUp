...
import {Users, UserPlus, UserCheck, UserRoundPen,MessageSquare, User } from 'lucide-react'
...
}
{
  currentTab === 'Connections' && (
    <button onClick={()=>navigate(`/messages/${user._id}`)} className=' flex items-center justify-center gap-2      w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer'>
