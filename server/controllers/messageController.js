...
// Create an empty object to store ss envent connections
const connections = {};
...
export const sseController = (req, res) => {
  ...
  res.write("log:Conneciton to SSE stream\n\n");
...
export const getChatMessages = async (req, res) => {
  try {
    ...
    const messages = await Message.find({
      $or: [
        { from_user_id: userId, to_user_id: to_userId },
        { from_user_id: to_userId, to_user_id: userId },
      ],
    }).sort({created_at:-1})
